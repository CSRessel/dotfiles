...
class DesktopAppsTest(unittest.TestCase):
    def test_merge_availability_and_repeat(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name in ['firefox.desktop', 'org.videolan.VLC.desktop', 'dev.zed.Zed.desktop', 'com.mitchellh.ghostty.desktop']:
            ...
            self.assertEqual(defaults['x-scheme-handler/terminal'], 'com.mitchellh.ghostty.desktop;')
            self.assertEqual(defaults['application/x-terminal-emulator'], 'com.mitchellh.ghostty.desktop;')
